...
const visibleControl = document.getElementById('id_visible')
...
if (deleted){
    handelAlerts('danger', `deleted "${deleted}"`)
    localStorage.clear()
}
                    ...
                    postsBox.innerHTML += `
                        <div class="card mb-2">
                            <div class="card-body">
                                ...
                                <small>User: <a href="${url}profiles/u/${el.author}"><strong>${el.author}</strong></a></small>
                            </div>
...
postForm.addEventListener('submit', e=>{
    ...
    $.ajax({
        ...
        data: {
            ...
            'visible':visibleControl.checked
        },
        success: function(response){
            console.log(response);
            ...
            handelAlerts('success', 'New post added!')
