    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notification_type', models.CharField(choices=[('message', 'Message'), ('follower', 'Follower'), ('like', 'Like'), ('mention', 'Mention'), ('update', 'Update'), ('comment', 'comment'), ('mcomment', 'mcomment')], max_length=20)),
